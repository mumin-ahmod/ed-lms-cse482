...
<div class="timeline-posts-section">
    ...
    <div class="card mb-3 shadow-sm">
        <div class="card-body">
            ...
            <p class="card-text">This is a brief description of the timeline post. Additional details about the post can be provided here.</p>
    ...
    <div class="card mb-3 shadow-sm">
        <div class="card-body">
            ...
            <p class="card-text">Another timeline post with more information.</p>
