        ...
        <form id="form-courses-website">
            ...
            <div class="mb-3">
                ...
                <input type="tel" class="form-control" id="phone-field" name="phone" placeholder="Enter your phone number" required>
                        ...
                        <!-- Teacher Code Giver From Admin -->
                        <div class="mb-3">
                <label for="phone-field" class="form-label">Teacher Code</label>
                <input type="tel" class="form-control" id="phone-field" name="teachercode" placeholder="Enter your Teacher Code" required>
            </div>
